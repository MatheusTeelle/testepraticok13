<html>
	...
	<body>
		<div id="seleciona">
		<h2> Deletar as Informações do Usuário </h2>
		<strong> Confira na Tabela Registro qual Usuário deseja DELETAR e Selecione seu ID abaixo: <br /><br /></strong>
			<form id="form0" action="deins.php" method="POST" autocomplete="off" >
				<select name="lista" id="lista" style="width: 300px">
